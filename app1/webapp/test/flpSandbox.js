		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Child App",
									"targetURL": "#comchildappapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchildappapp1-display": {
								"semanticObject": "comchildappapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.childapp.app1",
									"url": sap.ui.require.toUrl("com/childapp/app1")
								}
							}
						}
					}
