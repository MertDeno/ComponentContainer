		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parent App",
									"targetURL": "#parentappparentapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"parentappparentapp-display": {
								"semanticObject": "parentappparentapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=parentapp.parentapp",
									"url": sap.ui.require.toUrl("parentapp/parentapp")
								}
							}
						}
					}
